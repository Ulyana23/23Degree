    ...
    RadiosToSlider.prototype = {
        ...
        fitContainer: function() {
            ...
            if (this.options.fitContainer) {
                ...
                this.LEVEL_MARGIN = this.KNOB_MARGIN + 11;
            }
        },
        ...
        addBaseStyle: function() {
            var label = 0,
                slider = this,
                width = (this.numOptions * this.LEVEL_WIDTH) + (this.numOptions - 1) * this.LEVEL_MARGIN - 3;
            ...
            this.bearer.find('label').each(function() {
                ...
                if ($this.hasClass('end')) {
                    $this.css('left', leftPos - 45 + 'px');
                    if ($('.rectangle__top').outerWidth() <= 450) {
        ...
        setSlider: function() {
            ...
            $inputs.each(function() {
                ...
                if ($this.prop('checked')) {
                    var width = (radio * slider.KNOB_WIDTH) + (radio - 1) * slider.KNOB_MARGIN - 10;
